...
"""
This script is ran by "streamlit run __file__" and lets the user plot
...
Assumes the following file structure:
    ...
    data/ghcnd_hcn/*.dly
    src/wxdata_explorer/
    src/wxdata_explorer/__init__.py
    src/wxdata_explorer/wx-ghcnd.py

where DATA_PATH resolves to data/
